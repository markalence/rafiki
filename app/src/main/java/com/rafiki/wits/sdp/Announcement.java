...
public class Announcement {
    ...
    Announcement(Context context, LayoutInflater inflater) {
        mInflater = inflater;
        mContext = context;
    }
    ...
    public boolean announcementDialogInit() {
        moduleView = mInflater.inflate(R.layout.record_module, null);
        ...
        et.setHint("Make your announcement here");
        final AlertDialog.Builder recordBuilder = new AlertDialog.Builder(mContext);
        recordBuilder.setView(moduleView);
        recordDialog = recordBuilder.create();
        recordDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        ...
        moduleConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                docData.put("courseCode", courseSelection.toLowerCase());
                docData.put("studentNumber", LoginActivity.studentNum);
                docData.put("announcement",et.getText().toString());
                docData.put("date",new Timestamp(new Date()));
                firestore.collection("announcements").add(docData);
                recordDialog.dismiss();
                Toast.makeText(mContext, "Thank you! Your announcement has been made.", Toast.LENGTH_SHORT).show();
            }
        });
